                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell
                        ...
                        scope="row"
                        padding="none"
                      >{`${affectationDetails.collaborateurDetails[0].Nom} ${affectationDetails.collaborateurDetails[0].Prenom}`}</TableCell>
                      <TableCell>
                        {affectationDetails.vehiculeDetails.length > 0
                          ? `${affectationDetails.vehiculeDetails[0].Marque} ${affectationDetails.vehiculeDetails[0].WW}`
                          : 'No Vehicule Details'}
                      </TableCell>
